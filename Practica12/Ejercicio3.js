...
class Coche {
    ...
    frenar(decremento) {
    if (decremento > 0 && this._velocidad >= decremento) {
    ...
    } else if (this._velocidad < decremento) {
...
miCoche.frenar(15); // Se muestra un mensaje si el decremento es demasiado alto
